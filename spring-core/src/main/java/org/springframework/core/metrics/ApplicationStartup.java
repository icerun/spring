 ...
 * <p>核心容器及其基础结构组件可以使用{@code ApplicationStartup}标记应用程序启动期间的步骤，并收集有关执行上下文或其处理时间的数据。
 *
 * @author Brian Clozel
 * @since 5.3
 */
public interface ApplicationStartup {
	 ...
	 * <p> 步骤名称描述当前操作或阶段。此技术名称应为“.”名称空间，并且可以在应用程序启动期间重用以描述同一步骤的其他实例。
