 ...
 * 【翻译】 策略接口，用于将位置模式（例如，Ant样式的路径模式）解析为{@link Resource}对象。
 *   这里可以了解一下策略模式https://blog.csdn.net/xsgjly2826/article/details/108448294
 *
 ...
 * 翻译： 这个接口继承自ResourceLoader接口（由类图可以看出ResourceLoader接口是一个定义接口）
 *
