 ...
 * 生成类来处理多值键，用于诸如 Maps 和 Sets 之类的东西。
 ...
 * <code>equals<code> 和 <code>hashCode<code> 方法的代码遵循 Joshua Bloch 在 <i>Effective Java<i> 中制定的规则。
 * <p>
...
abstract public class KeyFactory {
	...
	public static KeyFactory create(ClassLoader loader, Class keyInterface, KeyFactoryCustomizer customizer,
		...
		// 创建一个最简易的代理类生成器 即只会生成HashCodde equals toString newINstance方法
	...
	public static class Generator extends AbstractClassGenerator {
		...
		public KeyFactory create() {
			// 设置了改生成器生成代理类的名字前缀，即我们的接口名Enhancer.enhancerKey
		...
		public void generateClass(ClassVisitor v) {
			...
			// 4.3 遍历成员比那辆即newInstance方法的所有参数
